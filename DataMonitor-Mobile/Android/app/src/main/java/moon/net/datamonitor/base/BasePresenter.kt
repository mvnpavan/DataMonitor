...
import moon.net.datamonitor.injection.component.DaggerUserAuthenticationInjector
import moon.net.datamonitor.injection.component.UserAuthenticationInjector
...
abstract class BasePresenter<out v: BaseView>(protected val view: v) {
    ...
    private val injector: UserAuthenticationInjector = DaggerUserAuthenticationInjector
            .builder()
            .baseView(view)
